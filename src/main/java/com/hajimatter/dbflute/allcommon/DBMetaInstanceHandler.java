...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("TWEET", "com.hajimatter.dbflute.bsentity.dbmeta.TweetDbm");
        tmpMap.put("USER", "com.hajimatter.dbflute.bsentity.dbmeta.UserDbm");
        tmpMap.put("USER_FOLLOWING", "com.hajimatter.dbflute.bsentity.dbmeta.UserFollowingDbm");
