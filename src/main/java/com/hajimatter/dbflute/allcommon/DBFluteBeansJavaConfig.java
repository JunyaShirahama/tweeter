package com.hajimatter.dbflute.allcommon;
...
import com.hajimatter.dbflute.allcommon.DBFluteInitializer;
 ...
 */
@Configuration
@ComponentScan(value="com.hajimatter.dbflute.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new com.hajimatter.dbflute.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new com.hajimatter.dbflute.allcommon.ImplementedInvokerAssistant();
    }
