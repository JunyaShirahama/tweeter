...
public abstract class BsUserFollowingBhv extends AbstractBehaviorWritable<UserFollowing, UserFollowingCB> {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<UserFollowing> selectByPK(Long userFollowingId) {
        return facadeSelectByPK(userFollowingId);
    }

    protected OptionalEntity<UserFollowing> facadeSelectByPK(Long userFollowingId) {
        return doSelectOptionalByPK(userFollowingId, typeOfSelectedEntity());
    }

    protected <ENTITY extends UserFollowing> ENTITY doSelectByPK(Long userFollowingId, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(userFollowingId), tp);
    }

    protected <ENTITY extends UserFollowing> OptionalEntity<ENTITY> doSelectOptionalByPK(Long userFollowingId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(userFollowingId, tp), userFollowingId);
    }

    protected UserFollowingCB xprepareCBAsPK(Long userFollowingId) {
        assertObjectNotNull("userFollowingId", userFollowingId);
        return newConditionBean().acceptPK(userFollowingId);
    }
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<UserFollowing> selectByUniqueOf(Long followerUserId, Long followingUserId) {
        return facadeSelectByUniqueOf(followerUserId, followingUserId);
    }

    protected OptionalEntity<UserFollowing> facadeSelectByUniqueOf(Long followerUserId, Long followingUserId) {
        return doSelectByUniqueOf(followerUserId, followingUserId, typeOfSelectedEntity());
    }

    protected <ENTITY extends UserFollowing> OptionalEntity<ENTITY> doSelectByUniqueOf(Long followerUserId, Long followingUserId, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOf(followerUserId, followingUserId), tp), followerUserId, followingUserId);
    }

    protected UserFollowingCB xprepareCBAsUniqueOf(Long followerUserId, Long followingUserId) {
        assertObjectNotNull("followerUserId", followerUserId);assertObjectNotNull("followingUserId", followingUserId);
        return newConditionBean().acceptUniqueOf(followerUserId, followingUserId);
    }
     ...
     */
    public List<User> pulloutUserByFollowingUserId(List<UserFollowing> userFollowingList)
    { return helpPulloutInternally(userFollowingList, "userByFollowingUserId"); }
     ...
     * @return The list of foreign table. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<User> pulloutUserByFollowerUserId(List<UserFollowing> userFollowingList)
    { return helpPulloutInternally(userFollowingList, "userByFollowerUserId"); }

    // ===================================================================================
    //                                                                      Extract Column
    //                                                                      ==============
    /**
     * Extract the value list of (single) primary key userFollowingId.
     * @param userFollowingList The list of userFollowing. (NotNull, EmptyAllowed)
     * @return The list of the column value. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<Long> extractUserFollowingIdList(List<UserFollowing> userFollowingList)
    { return helpExtractListInternally(userFollowingList, "userFollowingId"); }
