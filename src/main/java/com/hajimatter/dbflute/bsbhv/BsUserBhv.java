package com.hajimatter.dbflute.bsbhv;
...
import com.hajimatter.dbflute.bsbhv.loader.*;
import com.hajimatter.dbflute.exentity.*;
import com.hajimatter.dbflute.bsentity.dbmeta.*;
...
public abstract class BsUserBhv extends AbstractBehaviorWritable<User, UserCB> {
     ...
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadUserFollowingByFollowingUserId</span>(<span style="color: #553000">userList</span>, <span style="color: #553000">followingCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<UserFollowing> loadUserFollowingByFollowingUserId(List<User> userList, ReferrerConditionSetupper<UserFollowingCB> refCBLambda) {
        xassLRArg(userList, refCBLambda);
        return doLoadUserFollowingByFollowingUserId(userList, new LoadReferrerOption<UserFollowingCB, UserFollowing>().xinit(refCBLambda));
    }
     ...
     * USER_FOLLOWING by FOLLOWING_USER_ID, named 'userFollowingByFollowingUserIdList'.
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadUserFollowingByFollowingUserId</span>(<span style="color: #553000">user</span>, <span style="color: #553000">followingCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">followingCB</span>.setupSelect...
     *     <span style="color: #553000">followingCB</span>.query().set...
     *     <span style="color: #553000">followingCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">user</span>.<span style="color: #CC4747">getUserFollowingByFollowingUserIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<UserFollowing> loadUserFollowingByFollowingUserId(User user, ReferrerConditionSetupper<UserFollowingCB> refCBLambda) {
        xassLRArg(user, refCBLambda);
        return doLoadUserFollowingByFollowingUserId(xnewLRLs(user), new LoadReferrerOption<UserFollowingCB, UserFollowing>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<UserFollowing> doLoadUserFollowingByFollowingUserId(List<User> userList, LoadReferrerOption<UserFollowingCB, UserFollowing> option) {
        return helpLoadReferrerInternally(userList, option, "userFollowingByFollowingUserIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadUserFollowingByFollowerUserId</span>(<span style="color: #553000">userList</span>, <span style="color: #553000">followingCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">followingCB</span>.setupSelect...
     *     <span style="color: #553000">followingCB</span>.query().set...
     *     <span style="color: #553000">followingCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<UserFollowing> loadUserFollowingByFollowerUserId(List<User> userList, ReferrerConditionSetupper<UserFollowingCB> refCBLambda) {
        xassLRArg(userList, refCBLambda);
        return doLoadUserFollowingByFollowerUserId(userList, new LoadReferrerOption<UserFollowingCB, UserFollowing>().xinit(refCBLambda));
    }
     ...
     * USER_FOLLOWING by FOLLOWER_USER_ID, named 'userFollowingByFollowerUserIdList'.
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadUserFollowingByFollowerUserId</span>(<span style="color: #553000">user</span>, <span style="color: #553000">followingCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">followingCB</span>.setupSelect...
     *     <span style="color: #553000">followingCB</span>.query().set...
     *     <span style="color: #553000">followingCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">user</span>.<span style="color: #CC4747">getUserFollowingByFollowerUserIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<UserFollowing> loadUserFollowingByFollowerUserId(User user, ReferrerConditionSetupper<UserFollowingCB> refCBLambda) {
        xassLRArg(user, refCBLambda);
        return doLoadUserFollowingByFollowerUserId(xnewLRLs(user), new LoadReferrerOption<UserFollowingCB, UserFollowing>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<UserFollowing> doLoadUserFollowingByFollowerUserId(List<User> userList, LoadReferrerOption<UserFollowingCB, UserFollowing> option) {
        return helpLoadReferrerInternally(userList, option, "userFollowingByFollowerUserIdList");
    }
