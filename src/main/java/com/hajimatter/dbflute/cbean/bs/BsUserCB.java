...
public class BsUserCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<UserCQ> {
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<UserFollowingCB, UserCQ> derivedUserFollowingByFollowingUserId() {
            assertDerived("userFollowingByFollowingUserIdList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<UserFollowingCB> sq, UserCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveUserFollowingByFollowingUserIdList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from USER_FOLLOWING where ...) as FOO_MAX} <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<UserFollowingCB, UserCQ> derivedUserFollowingByFollowerUserId() {
            assertDerived("userFollowingByFollowerUserIdList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<UserFollowingCB> sq, UserCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveUserFollowingByFollowerUserIdList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
