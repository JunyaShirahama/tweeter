...
public class TweetCIQ extends AbstractBsTweetCQ {
    ...
    protected ConditionValue xgetCValueContents() { return _myCQ.xdfgetContents(); }
    protected ConditionValue xgetCValueTweetDatetime() { return _myCQ.xdfgetTweetDatetime(); }
